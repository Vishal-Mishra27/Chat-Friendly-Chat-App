...
const Logo = () => {
  return (
    <div className="flex p-0 justify-start items-center gap-2">
      ...
      <img
        src="Chatlogo-removebg-preview.png"
        alt="New Logo"
        className="w-44 h-44 rounded-full object-cover" // Make image circular with a border
      />
      <div className="flex flex-col mb-7">
        <span className="text-4xl font-semibold  text-purple-700">Chat</span>
        <span className="text-2xl font-semibold text-purple-400">Friendly</span>
      </div>
    </div>
  );
};
